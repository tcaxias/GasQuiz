import type { Player, PlayerPosition, PlayerFoot, DetailedPosition } from '$lib/types/quiz';

type P = [string, number, PlayerPosition, PlayerFoot, DetailedPosition?];
...
export const players: Player[] = [
  // ── FC Porto ──────────────────────────────────────────
  ...team('FC Porto', [
    ['Diogo Costa', 99, 'GR', 'right', 'guarda_redes'],
    ['Cláudio Ramos', 14, 'GR', 'right', 'guarda_redes'],
    ['Jakub Kiwior', 4, 'DEF', 'left', 'defesa_central'],
    ['Nehuén Pérez', 18, 'DEF', 'right', 'defesa_central'],
    ['Jan Bednarek', 5, 'DEF', 'right', 'defesa_central'],
    ['Dominik Prpić', 21, 'DEF', 'left', 'defesa_central'],
    ['Thiago Silva', 3, 'DEF', 'right', 'lateral_direito'],
    ['Francisco Moura', 74, 'DEF', 'left', 'lateral_esquerdo'],
    ['Zaidu Sanusi', 12, 'DEF', 'left', 'lateral_esquerdo'],
    ['Alberto Costa', 20, 'DEF', 'right', 'lateral_direito'],
    ['Martim Fernandes', 52, 'DEF', 'right', 'lateral_direito'],
    ['Alan Varela', 22, 'MED', 'right', 'trinco'],
    ['Pablo Rosario', 13, 'MED', 'right', 'medio'],
    ['Victor Froholdt', 8, 'MED', 'right', 'medio'],
    ['Seko Fofana', 42, 'MED', 'right', 'medio'],
    ['Rodrigo Mora', 86, 'MED', 'right', 'medio_ofensivo'],
    ['Gabri Veiga', 10, 'MED', 'right', 'medio_ofensivo'],
    ['Borja Sainz', 17, 'AV', 'right', 'extremo_esquerdo'],
    ['Yann Karamoh', 75, 'AV', 'right', 'extremo_direito'],
    ['William Gomes', 7, 'AV', 'left', 'extremo_esquerdo'],
    ['Pepê', 11, 'AV', 'right', 'extremo_direito'],
    ['Samu Aghehowa', 9, 'AV', 'right', 'ponta_de_lanca'],
    ['Terem Moffi', 29, 'AV', 'left', 'ponta_de_lanca'],
    ['Deniz Gül', 27, 'AV', 'right', 'ponta_de_lanca'],
    ['Luuk de Jong', 26, 'AV', 'right', 'ponta_de_lanca'],
  ]),

  // ── SL Benfica ────────────────────────────────────────
  ...team('SL Benfica', [
    ['Anatoliy Trubin', 1, 'GR', 'right', 'guarda_redes'],
    ['Samuel Soares', 24, 'GR', 'right', 'guarda_redes'],
    ['António Silva', 4, 'DEF', 'right', 'defesa_central'],
    ['Tomás Araújo', 44, 'DEF', 'right', 'defesa_central'],
    ['Nicolás Otamendi', 30, 'DEF', 'right', 'defesa_central'],
    ['Samuel Dahl', 26, 'DEF', 'left', 'lateral_esquerdo'],
    ['Amar Dedić', 17, 'DEF', 'right', 'lateral_direito'],
    ['Alexander Bah', 6, 'DEF', 'right', 'lateral_direito'],
    ['Richard Ríos', 20, 'MED', 'right', 'medio'],
    ['Enzo Barrenechea', 5, 'MED', 'right', 'trinco'],
    ['Fredrik Aursnes', 8, 'MED', 'right', 'medio'],
    ['Leandro Barreiro', 18, 'MED', 'right', 'medio'],
    ['Georgiy Sudakov', 10, 'MED', 'both', 'medio_ofensivo'],
    ['Andreas Schjelderup', 21, 'AV', 'right', 'extremo_esquerdo'],
    ['Bruma', 7, 'AV', 'right', 'extremo_direito'],
    ['Dodi Lukébakio', 11, 'AV', 'left', 'extremo_esquerdo'],
    ['Gianluca Prestianni', 25, 'AV', 'right', 'extremo_direito'],
    ['Rafa Silva', 27, 'AV', 'right', 'extremo_direito'],
    ['Vangelis Pavlidis', 14, 'AV', 'both', 'ponta_de_lanca'],
    ['Franjo Ivanović', 9, 'AV', 'right', 'ponta_de_lanca'],
  ]),

  // ── Sporting CP ───────────────────────────────────────
  ...team('Sporting CP', [
    ['Rui Silva', 1, 'GR', 'left', 'guarda_redes'],
    ['João Virgínia', 12, 'GR', 'left', 'guarda_redes'],
    ['Ousmane Diomande', 26, 'DEF', 'right', 'defesa_central'],
    ['Gonçalo Inácio', 25, 'DEF', 'left', 'defesa_central'],
    ['Zeno Debast', 6, 'DEF', 'right', 'defesa_central'],
    ['Eduardo Quaresma', 72, 'DEF', 'right', 'defesa_central'],
    ['Maxi Araújo', 20, 'DEF', 'left', 'lateral_esquerdo'],
    ['Nuno Santos', 11, 'DEF', 'left', 'lateral_esquerdo'],
    ['Iván Fresneda', 22, 'DEF', 'right', 'lateral_direito'],
    ['Morten Hjulmand', 42, 'MED', 'right', 'trinco'],
    ['Daniel Bragança', 23, 'MED', 'left', 'medio'],
    ['Hidemasa Morita', 5, 'MED', 'right', 'medio'],
    ['Giorgi Kochorashvili', 14, 'MED', 'right', 'medio'],
    ['Francisco Trincão', 17, 'MED', 'left', 'extremo_direito'],
    ['Pedro Gonçalves', 8, 'AV', 'right', 'medio_ofensivo'],
    ['Geovany Quenda', 7, 'AV', 'left', 'extremo_direito'],
    ['Geny Catamo', 10, 'AV', 'left', 'extremo_esquerdo'],
    ['Luis Suárez', 97, 'AV', 'right', 'ponta_de_lanca'],
    ['Fotis Ioannidis', 89, 'AV', 'both', 'ponta_de_lanca'],
  ]),
